...
<footer>
			...
			<div class="sel_family_group">
				...
				<div class="sel_option_list hide">
					<dl>
						<dt>CJ그룹</dt>
						<dd>
							<a href="#" target="_blank" title="CJ 주식회사 새창으로 열기">CJ주식회사</a>
						</dd>
					</dl>
					<dl>
						...
						<dt>식품 &amp; 식품서비스</dt>
						<dd>
							<a href="#" target="_blank" title="CJ제일제당 (식품) 새창으로 열기">CJ제일제당</a>
						</dd>
						<dd>
							<a href="#" target="_blank" title="CJ푸드빌 새창으로 열기">CJ푸드빌</a>
						</dd>
						<dd>
							<a href="#" target="_blank" title="CJ프레시웨이 새창으로 열기">CJ프레시웨이</a>
						</dd>
					...
					<dl>
						<dt>생명공학</dt>
						<dd>
							<a href="#" target="_blank" title="CJ제일제당 (바이오) 새창으로 열기">CJ제일제당
								BIO사업부문</a>
						</dd>
						<dd>
							<a href="#" target="_blank" title="CJ Feed&amp;Care 새창으로 열기">CJ
								Feed&amp;Care</a>
						</dd>
					...
					<dl>
						<dt>물류 &amp; 신유통</dt>
						<dd>
							<a href="#" target="_blank" title="CJ대한통운 새창으로 열기">CJ대한통운</a>
						</dd>
						<dd>
							<a href="#" target="_blank" title="CJ대한통운 (건설) 새창으로 열기">CJ대한통운
								건설부문</a>
						</dd>
						<dd>
							<a href="#" target="_blank" title="CJ올리브영 새창으로 열기">CJ올리브영</a>
						</dd>
						<dd>
							<a href="#" target="_blank" title="CJ올리브네트웍스 (IT사업) 새창으로 열기">CJ올리브네트웍스</a>
						</dd>
						<dd>
							<a href="#" target="_blank" title="CJ ENM (오쇼핑) 새창으로 열기">CJ
								ENM 커머스부문</a>
						</dd>
					...
					<dl>
						<dt>엔터테인먼트 &amp; 미디어</dt>
						<dd>
							<a href="#" target="_blank" title="CJ ENM (E&amp;M)새창으로 열기">CJ
								ENM 엔터테인먼트부문</a>
						</dd>
						<dd>
							<a href="#" target="_blank" title="CJ CGV 새창으로 열기">CJ CGV</a>
						</dd>
	...
	<div class="fourConts">
		<div class="conts">
			<ol>
				<li class="isms">정보보호 및 개인정보보호 관리체계 ISMS-P 인증 획득 <span
					class="bar">인증 범위 : CJ올리브영 쇼핑몰 운영</span> <span class="bar">유효기간
						: 2023.12.06~2026.12.05</span>
				</li>
			</ol>
		</div>
	</div>
